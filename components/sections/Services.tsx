    ...
    <div className="min-h-screen mt-32">
      ...
      {services.map((service, i) => (
        ...
        >
          <div
            style={{
              background: `linear-gradient(135deg, ${service.color}1a, ${service.color}26)`,
              borderColor: service.color + "30",
            }}
            className="min-h-[600px] max-w-7xl w-full rounded-3xl shadow-xl border border-dashed border-opacity-30 backdrop-blur-md overflow-hidden transition-transform hover:scale-[1.01] duration-300"
          >
            <div className="grid lg:grid-cols-2">
              {/* Content Side */}
              <div className="p-8 lg:p-12 flex flex-col justify-center bg-white/70 backdrop-blur-sm">
                <div>
                  <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-6 text-slate-800 leading-tight">
                    {service.title}
                  </h2>
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 mb-12 bg-gray-100">
        <div className="text-center z-10 mx-auto static top-0">
          <h2 className="absolute top-20 left-8 text-6xl sm:text-5xl md:text-9xl lg:text-[180px] font-bold mb-4 text-black tracking-tighter">
            KICK <span className="text-teal-600">OFF</span>
          </h2>

          <h2 className="absolute top-40 sm:top-60 md:top-32 lg:top-[260px] left-8 sm:left-16 md:left-50 text-6xl md:text-9xl lg:text-[180px] font-bold mb-4 text-black tracking-tighter">
            YOUR JOURNEY
          </h2>

          <h2 className="absolute top-60 sm:top-48 md:top-56 lg:top-[460px] left-8 sm:left-20 md:left-70 lg:left-120 text-6xl md:text-9xl lg:text-[180px] font-bold mb-4 text-black tracking-tighter">
            LET&apos;S BUILD
          </h2>

          <h2 className="absolute top-80 sm:top-64 md:top-80 lg:top-[660px] left-8 sm:left-20 md:left-24 lg:left-200 text-6xl md:text-9xl lg:text-[180px] font-bold mb-4 text-teal-600 tracking-tighter">
            TOGETHER
          </h2>
        </div>
      </div>
